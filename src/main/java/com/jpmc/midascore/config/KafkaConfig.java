...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Transaction> consumerFactory(KafkaProperties kafkaProperties) {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "midas-core");
        properties.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        properties.put(JsonDeserializer.TRUSTED_PACKAGES, "com.jpmc.midascore.foundation");
        properties.put(JsonDeserializer.VALUE_DEFAULT_TYPE, Transaction.class.getName());
